...
// scene.background = cubeTextureLoader.load([star, star, star, star, star, star]);
...
box2.material.map = textureLoader.load(star);

const plane2Geo = new THREE.PlaneGeometry(10, 10, 50);
...
gui.add(options, "intensity", 0, 4000);
